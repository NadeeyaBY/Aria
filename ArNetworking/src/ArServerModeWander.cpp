...
AREXPORT ArServerModeWander::ArServerModeWander(ArServerBase *server, ArRobot *robot, int forwardVel, int avoidFrontDist, int avoidVel, int turnAmt) : 
  ArServerMode(robot, server, "wander"),
  myWanderGroup(robot, forwardVel, avoidFrontDist, avoidVel, turnAmt),
  myNetWanderCB(this, &ArServerModeWander::netWander)
{
  ...
  myStopIfNoRangeDevicesAction.setRobot(robot);
  myWanderGroup.addAction(&myStopIfNoRangeDevicesAction, 1);
}
